...
Apply a custom accent while preserving the current preset:

```lua
UI:SetAccent(Color3.fromRGB(180, 92, 255))
```

Color pickers can do this automatically:
...
Custom themes inherit missing values from `Astra`, but defining all tokens is
